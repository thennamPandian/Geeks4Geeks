...
public class HeapUtilTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(" \n left Child : "
				+ HeapUtil.leftChild(maxHeap, -1));

		// right Child
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 0));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 1));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 2));

		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 3));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 4));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 5));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 6));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, 7));
		System.out.println(" \n right Child : "
				+ HeapUtil.rightChild(maxHeap, -1));
		...
		// Deleting an element
		System.out.println("\n");
		elements = new int[] { 15, 10, 11, 9, 8, 7, 6, 4, 3 };
		maxHeap = HeapUtil.createHeap(20, elements);
		HeapUtil.printHeap(maxHeap);
		HeapUtil.deleteElement(maxHeap, 10);
		System.out.println("\n");
		HeapUtil.printHeap(maxHeap);
	}
